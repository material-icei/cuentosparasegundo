...
const QUESTIONS = [
  {
    type: 'mc',
    text: '¿Dónde se juntó el grupo de amigos antes del partido?',
    options: ['En la plaza del barrio', 'En la escuela', 'En un club', 'En una casa'],
    correct: 0
  },
  {
    type: 'vf',
    text: 'El grupo llegó tarde y se perdió el comienzo del partido.',
    correct: false
  },
  {
    type: 'mc',
    text: '¿Qué se pusieron todos para mostrar que eran un equipo?',
    options: ['Gorras', 'La camiseta', 'Medias iguales', 'Pulseras'],
    correct: 1
  },
  {
    type: 'vf',
    text: 'Mientras esperaban que empezara el partido, el grupo cantó una canción juntos.',
    correct: true
  },
  {
    type: 'mc',
    text: '¿Qué llevó uno de ellos para compartir con los demás?',
    options: ['Una pelota', 'Algo para comer', 'Un juego de mesa', 'Una radio'],
    correct: 1
  },
  {
    type: 'vf',
    text: 'Se acomodaron lejos de la pantalla porque no les importaba ver bien el partido.',
    correct: false
  },
  {
    type: 'mc',
    text: '¿Qué les dijo el adulto que los acompañaba?',
    options: ['"No se separen, yo estoy acá"', '"Vuelvan a casa"', '"No hagan ruido"', '"Cambien de lugar"'],
    correct: 0
  },
  {
    type: 'vf',
    text: 'Cuando patearon al arco, la pelota entró y fue gol.',
    correct: false
  },
  {
    type: 'mc',
    text: 'Después de que la pelota salió afuera, ¿qué hizo el grupo?',
    options: ['Se fueron enojados', 'Dejaron de alentar', 'Volvieron a cantar más fuerte y juntos', 'Se pelearon'],
    correct: 2
  },
  {
    type: 'order',
    ...
    items: [
      'El grupo se junta en la plaza y se pone la camiseta',
      'Cantan la canción del equipo mientras esperan',
      'Se acomodan cerca de la pantalla para ver el partido',
      'Patean al arco, la pelota sale afuera y vuelven a alentar'
    ],
    correct: [0, 1, 2, 3]
  }
];
...
function showFinalScreen() {
  ...
  if (stars === total) badges.push({ emoji: '⚽', label: 'Hincha número 1' });
