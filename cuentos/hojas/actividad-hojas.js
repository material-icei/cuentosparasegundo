...
const QUESTIONS = [
  {
    type: 'mc',
    text: '¿Quiénes tuvieron la idea de juntar hojas en el bosque?',
    options: ['Un grupo de primos', 'Unos vecinos', 'Los maestros', 'Un perro y su dueño'],
    correct: 0
  },
  {
    type: 'vf',
    text: 'Los primos juntaron muy pocas hojas, apenas un puñado.',
    correct: false
  },
  {
    type: 'mc',
    text: '¿De qué colores eran las hojas que juntaron?',
    options: ['Amarillas, marrones, rojizas y naranjas', 'Verdes y azules', 'Blancas y negras', 'Solo verdes'],
    correct: 0
  },
  {
    type: 'order',
    text: 'Ordená cómo armaron la montaña de hojas, del primero al último:',
    items: [
      'Los primos deciden juntar hojas secas en el bosque',
      'Buscan hojas debajo de los árboles y cerca de los troncos',
      'Van juntando todas las hojas en el mismo lugar',
      'La montaña de hojas se hace cada vez más alta, hasta quedar enorme'
    ],
    correct: [0, 1, 2, 3]
  },
  {
    type: 'vf',
    text: 'Después de tirarse una vez sobre la montaña, los primos no quisieron volver a intentarlo.',
    correct: false
  },
  {
    type: 'match',
    ...
    pairs: [
      ['Buscaron hojas por todo el bosque', 'Juntaron hojas de muchos colores'],
      ['La pila de hojas creció y creció', 'Se hizo una montaña enorme'],
      ['Se tiraron sobre la montaña', 'Se escuchó el sonido ¡CRASH!'],
      ['Terminó el día de juego', 'Se quedaron mirando la montaña, felices']
    ]
  },
  {
    type: 'mc',
    text: '¿Qué sonido se escuchó cuando se tiraron sobre la montaña de hojas?',
    options: ['Splash', 'Crash', 'Boom', 'Ring'],
    correct: 1
  },
  {
    type: 'order',
    text: 'Ordená cómo jugaron con la montaña, del primero al último:',
    items: [
      'Corren y saltan sobre la montaña de hojas',
      'Se escucha el sonido ¡CRASH! y las hojas se mueven',
      'Se ríen, se levantan y vuelven a intentarlo varias veces',
      'Al terminar el día, se quedan mirando la montaña, cansados pero felices'
    ],
    correct: [0, 1, 2, 3]
  },
  {
    type: 'vf',
    text: 'Al final del día, terminaron con hojas en el piso, en la ropa y en el pelo.',
    correct: true
  },
  {
    type: 'match',
    ...
    pairs: [
      ['Crujían', 'Hacían un sonido seco, como al romperse'],
      ['Enorme', 'Muy grande'],
      ['Recorrieron', 'Caminaron explorando un lugar'],
      ['Cansados pero felices', 'Cómo se sintieron al final del día']
    ]
  }
];
...
function showFinalScreen() {
  ...
  if (stars === total) badges.push({ emoji: '🍂', label: 'Reyes de la montaña de hojas' });
