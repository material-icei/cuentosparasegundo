...
const QUESTIONS = [
  {
    type: 'mc',
    text: '¿Quiénes son los amigos protagonistas del cuento?',
    options: ['Juan y María', 'Lila y Teo', 'Cala y Juan', 'Simón y Manchitas'],
    correct: 0
  },
  {
    type: 'vf',
    text: 'A Juan le costó atar sus cordones al principio del cuento.',
    correct: true
  },
  {
    type: 'mc',
    text: '¿Quién ayudó a Juan a aprender a atarse los cordones?',
    options: ['Su mamá', 'María', 'Un maestro', 'Nadie, lo hizo solo'],
    correct: 1
  },
  {
    type: 'vf',
    text: 'María le explicó los pasos una sola vez y no volvió a repetirlos.',
    correct: false
  },
  {
    type: 'mc',
    text: '¿Con qué comparó María el segundo paso, la "orejita"?',
    options: ['Con una mariposa', 'Con un tren', 'Con una estrella', 'Con una pelota'],
    correct: 0
  },
  {
    type: 'vf',
    text: 'A Juan no le importaba que sus cordones tocaran el piso con barro.',
    correct: false
  },
  {
    type: 'mc',
    text: '¿Qué hizo Juan cuando no le salía al principio?',
    options: [
      'Se rindió y dejó de intentar',
      'Se enojó y se fue',
      'Volvió a intentar sin rendirse',
      'Le pidió a otro amigo que lo hiciera'
    ],
    correct: 2
  },
  {
    type: 'mc',
    text: 'Cuando los cordones quedaron firmes, ¿qué hizo Juan?',
    options: [
      'Se sentó a descansar',
      'Sonrió, se paró y salió corriendo a jugar',
      'Se puso a llorar',
      'Volvió a desatarlos'
    ],
    correct: 1
  ...
  {
    type: 'vf',
    text: 'María pensó que a veces no sale a la primera, pero intentando de nuevo las cosas empiezan a salir.',
    correct: true
  },
  {
    type: 'order',
    ...
    items: [
      'Juan intenta atarse los cordones solo y no puede',
      'María se sienta a su lado y le explica los pasos',
      'Juan lo intenta varias veces sin rendirse',
      'Los cordones quedan firmes y Juan sale a jugar'
    ],
    correct: [0, 1, 2, 3]
  }
];
...
function showFinalScreen() {
  ...
  if (stars === total) badges.push({ emoji: '👟', label: 'Maestro de los cordones' });
