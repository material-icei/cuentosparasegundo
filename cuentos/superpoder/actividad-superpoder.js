/* =========================================================
   ...
   "El superpoder de todos los días"
   ========================================================= */
...
const QUESTIONS = [
  {
    type: 'mc',
    text: '¿Qué imaginó tener el chico una mañana?',
    options: ['Un superpoder especial', 'Una capa mágica', 'Un objeto encantado', 'Un amigo invisible'],
    correct: 0
  },
  {
    type: 'vf',
    text: 'El superpoder que imaginó el chico era para volar.',
    correct: false
  },
  {
    type: 'mc',
    text: '¿Qué dijo el chico al salir y cruzarse con la gente?',
    options: ['Buen día', 'Chau', 'Nada, pasó de largo', 'Hasta mañana'],
    correct: 0
  },
  {
    type: 'vf',
    text: 'Cuando esperó su turno, el chico pidió las cosas con un "por favor".',
    correct: true
  },
  {
    type: 'mc',
    text: '¿Qué palabra usó el chico cuando alguien lo ayudó?',
    options: ['Gracias', 'De nada', 'Perdón', 'Bien'],
    correct: 0
  },
  {
    type: 'vf',
    text: 'Cuando algo no le salía como esperaba, el chico se enojaba y dejaba de intentar.',
    correct: false
  },
  {
    type: 'mc',
    text: '¿Qué palabra usaba el chico al pasar por un lugar?',
    options: ['Permiso', 'Auxilio', 'Cuidado', 'Cambio'],
    correct: 0
  },
  {
    type: 'vf',
    text: 'A medida que pasó el día, las personas empezaron a tratarlo mejor y a querer estar cerca de él.',
    correct: true
  },
  {
    type: 'mc',
    text: '¿Cuál descubrió el chico que era su verdadero superpoder?',
    options: [
      'Tener una capa mágica',
      'Las palabras y la forma de tratar a los demás',
      'Correr muy rápido',
      'Ser invisible'
    ],
    correct: 1
  },
  {
    ...
    items: [
      'El chico imagina que tiene un superpoder especial',
      'Saluda diciendo buen día y pide las cosas con por favor',
      'Usa permiso y hasta luego durante todo el día',
      'Antes de dormir, entiende que su superpoder son los buenos modales'
    ],
    correct: [0, 1, 2, 3]
  }
];
...
function showFinalScreen() {
  ...
  if (stars === total) badges.push({ emoji: '✨', label: 'Superhéroe de los buenos modales' });
