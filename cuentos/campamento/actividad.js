...
const QUESTIONS = [
  {
    type: 'mc',
    text: '¿Quiénes son las protagonistas del cuento?',
    options: ['Lía y Mora', 'Ana y Sofía', 'Mora y Juli', 'Lía y Juli'],
    correct: 0
  },
  {
    type: 'vf',
    text: 'La carpa se cayó y las nenas no pudieron armarla.',
    correct: false
  },
  {
    type: 'mc',
    text: '¿Qué hicieron apenas armaron la carpa?',
    options: [
      'Se pusieron a leer un cuento',
      'Corrieron una carrera hasta el árbol',
      'Se durmieron enseguida',
      'Fueron a nadar al lago'
    ],
    correct: 1
  },
  {
    type: 'vf',
    text: 'A la noche, Lía y Mora comieron junto a todos en una mesa larga.',
    correct: true
  },
  {
    type: 'mc',
    text: '¿Qué trajo Mora a escondidas dentro de la carpa?',
    options: ['Una linterna', 'Golosinas', 'Un libro', 'Un juego de cartas'],
    correct: 1
  },
  {
    type: 'order',
    ...
    items: [
      'Armaron la carpa',
      'Corrieron hasta el árbol',
      'Cenaron todos juntos',
      'Entraron a la carpa a dormir'
    ],
    // el orden correcto es el mismo que items (0,1,2,3)
    correct: [0, 1, 2, 3]
  },
  {
    type: 'vf',
    text: 'Cuando escucharon un ruido afuera, Lía y Mora sintieron un poco de miedo.',
    correct: true
  },
  {
    type: 'mc',
    text: 'Según lo que dicen las nenas, ¿qué pudo haber sido el ruido que escucharon?',
    options: [
      'Un grillo o el viento',
      'Un oso',
      'Un auto',
      'Un trueno'
    ],
  ...
  {
    type: 'mc',
    text: 'Aunque sintieron un poco de miedo, ¿cómo se quedaron finalmente?',
    options: [
      'Asustadas toda la noche',
      'Tranquilas, porque estaban juntas',
      'Enojadas entre ellas',
      'Aburridas'
    ],
    correct: 1
  },
  {
    type: 'vf',
    text: 'Antes de dormir, Lía y Mora dijeron que al otro día no iban a jugar más.',
    correct: false
  }
];
...
function renderOrder(card, q) {
  ...
  checkBtn.addEventListener('click', () => {
    ...
    checkBtn.disabled = true;
    if (!isCorrect) {
      // mostrar el orden correcto debajo
...
function showFinalScreen() {
  ...
  if (stars === total) badges.push({ emoji: '🏕️', label: 'Campista experto/a' });
